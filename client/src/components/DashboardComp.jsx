  ...
  return (
    <div className="p-3 md:mx-auto">
      <div className="flex-wrap flex gap-4 justify-center">
        <div className="flex flex-col p-3 border dark:border-slate-600 gap-4 md:w-72 w-full rounded-md shadow-md">
      ...
      <div className="flex flex-wrap gap-4 py-3 mx-auto justify-center">
        <div className="flex flex-col w-full md:w-auto shadow-lg p-2 rounded-md dark:bg-gray-800">
          <div className="flex justify-between p-3 text-sm font-light">
            ...
            <Button outline gradientDuoTone="purpleToPink" size="sm" pill>
            ...
            {users &&
              users.map((user) => (
                <Table.Body key={user._id} className="divide-y">
                  <Table.Row className="bg-white border dark:bg-gray-800 dark:border-gray-600">
                    <Table.Cell>
                      <img
        ...
        <div className="flex flex-col w-full md:w-auto shadow-lg p-2 rounded-md dark:bg-gray-800">
          <div className="flex justify-between p-3 text-sm font-light">
            <h1 className="text-center p-2">Commentaires</h1>
            <Button outline gradientDuoTone="purpleToPink" size="sm" pill>
              <Link to={"/dashboard?tab=comments"}>+</Link>
            </Button>
          </div>
          <Table hoverable>
            <Table.Head>
